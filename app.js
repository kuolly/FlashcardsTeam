...
const secretKey =
  "cf95b6c5004fd037052trth4th4th4t800e9thth54g3tg3tg3tg3567e625ac043326f2777d3b17a21e00d4b33dab26739b3f2de63d9506f17b228050";
...
serv.use(
  sessions({
    ...
    store: MongoStore.create({
      ...
      mongoUrl: "mongodb://localhost:27017/flash",
    }),
    cookie: {
...
serv.use((req, res, next) => {
  ...
  if (userId || req.path ==='/' || req.path === '/user/signin') {
    return next();
  }
